...
class _AuthenticationClient implements AuthenticationClient {
  ...
  @override
  Future<BaseResponse<String>> sendOtp(dynamic model) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = model;
  ...
  @override
  Future<BaseResponse<UserData>> verify(dynamic model) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = model;
  ...
  @override
  Future<dynamic> updatePassword(Map<String, dynamic> model) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(model);
    final _headers = <String, dynamic>{};
